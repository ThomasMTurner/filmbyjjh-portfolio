  ...
  return (
    <div className="Home">
        ...
        <div className="quotes-container">
          ...
          <QuotesContainerQuote quote={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vehicula tempus massa ut molestie. Curabitur interdum mollis viverra. Vestibulum nunc."} reference={"Washington DC"} />
        </div>
    </div>
  );
}
