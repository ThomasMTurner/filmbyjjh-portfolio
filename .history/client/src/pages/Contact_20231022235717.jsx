        ...
        <div className='email-form'>
            <label className='submit-button'>
                <form onSubmit={handleSubmit}>
                  <p style={{fontFamily:'helvetica', fontWeight:'bold', fontSize:'1.7rem', color:'black', width:'40rem', textAlign:'center'}}>Fill in the form below to start your videography or photography project.</p>
                    <TextFormComponent 
                    title='Full Name' 
                    type='SmallTextForm' 
