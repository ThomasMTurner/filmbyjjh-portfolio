  ...
  return (
    <div className="Home">
        ...
        <div className="quotes-container">
          ...
          <QuotesContainerQuote quotes=[<Quote {"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vehicula tempus massa ut molestie. Curabitur interdum mollis viverra. Vestibulum nunc."} reference={"Washington DC"} />
        </div>
    </div>
  );
}
