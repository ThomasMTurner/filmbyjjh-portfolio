        ...
        <>
            <div className='filters-list'>
                <div className='center-aligned-row-box' style={{gap:'0.3rem'}}>
                    ...
                    <button style={{all:'unset'}} onClick={() => props.setQuery({...props.query, 'sort': 'oldest'})}>
                        <MdCheck size={20}/>
                    </button>
                </div>
                <div className='center-aligned-row-box' style={{gap:'0.3rem'}}>
                    <p style={{fontFamily:'helvetica', fontWeight:'200'}}>Most recent</p>
                    <button style={{all:'unset'}} onClick={() => props.setQuery({...props.query, 'sort': 'most recent'})}>
                        <MdCheck size={20}/>
                    </button>
                </div>
...
const FilterMenu = (props) => {
    ...
    return (
        <div className='filter-menu'>
            ...
            {showFilters && props.filterType == 'date' && <FilterDateSubMenu query = {props.query} setQuery={props.setQuery}/> || props.filterType == 'tags' && <FilterTagSubMenu setQuery={props.setQuery}/>}
        </div>
    )
}
