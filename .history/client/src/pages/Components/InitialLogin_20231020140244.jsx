...
export function AdminForm (props) {
    ...
    return (
      ...
      <div style={{display:'flex', flexDirection:'row', alignItems:'center'}}>
        <button style={{all:'unset', position:'relative', right:'1rem'}} onMouseEnter={() => setButtonColours(prevState => ({ ...prevState, back: 'silver' }))} onMouseLeave={() => setButtonColours(prevState => ({ ...prevState, back: 'silver' }))} onClick={() => props.setAdminLogin(false)}>
