    ...
    return (
        <motion.div style={{display:'flex', justifyContent:'center'}} ref={ref} animate={{opacity: inView ? 1 : 0, y: inView ? 0 : -80}} transition={{duration:1,  type:'spring'}}>
            <div className='post-preview-container'>
                ...
                <p style={{fontFamily:'helvetica', fontSize:'2rem',  color:'black', fontWeight:'200', position:'relative', left:'0.5rem', textTransform:'uppercase', textShadow:'0px 2px 4px rgba(0, 0, 0, 0.4'}}>{title}</p>
