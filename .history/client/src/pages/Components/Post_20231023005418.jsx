...
import Logo from './Images/jacob-logo.jpg';
        ...
        <motion.div style={{display:'flex', justifyContent:'center'}} ref={ref} animate={{opacity: inView ? 1 : 0, y: inView ? 0 : -80}} transition={{duration:1,  type:'spring'}}>
            <div className='post-preview-container'>
                <div style={{display:'flex', flexDirection:'column', gap:'0', position:'relative', left:'0.5rem'}}>
                    <img src={Logo} alt='logo' style={{width:'3rem', height:'3rem', position:'relative', bottom:'0.5rem'}}></img>
                ...
                <p style={{fontFamily:'helvetica', fontSize:'2rem', color:'black', fontWeight:'bold', position:'relative', left:'0.5rem', textTransform:'uppercase'}}>{title}</p>
