    ...
    return (
        <motion.div style={{display:'flex', justifyContent:'center'}} ref={ref} animate={{opacity: inView ? 1 : 0, y: inView ? 0 : -80}} transition={{duration:1,  type:'spring'}}>
            <div className='post-preview-container'>
                ...
                <p style={{fontFamily:'helvetica', fontSize:'2rem', textDecoration:'underline', textDecorationThickness:'0.1rem', textDecorationColor:'black', textDecorationLine:' color:'black', fontWeight:'bold', position:'relative', left:'0.5rem', textTransform:'uppercase'}}>{title}</p>
