        ...
        <motion.div style={{display:'flex', justifyContent:'center'}} ref={ref} animate={{opacity: inView ? 1 : 0, y: inView ? 0 : -80}} transition={{duration:1,  type:'spring'}}>
            <div className='post-preview-container'>
                <div style={{display:'flex', flexDirection:'column', gap:'0', position:'relative', left:'0.5rem'}}>
                    ...
                    <p style={{fontWeight:'200', fontFamily:'helvetica', fontSize:'0.8rem', color:'darkgreen', position:'relative', bottom:'1rem', gap:'0.2rem', display:'flex'}}>Posted {getTimestamp()} ago <BiTimeFive size={15} />   </p>
                </div>
                <p style={{fontFamily:'helvetica', fontSize:'2rem', textDecoration:'underline', textDecorationThickness:'0.2rem', textUnderlineOffset:'0.1rem',  color:'darkgray', fontWeight:'bold', position:'relative', left:'0.5rem', textTransform:'uppercase'}}>{title}</p>
