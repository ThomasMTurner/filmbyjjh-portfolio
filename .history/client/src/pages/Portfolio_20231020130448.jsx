...
const PortfolioCard = (props) => {
    ...
    return (
        <div className={`portfolio-card portfolio-card-${props.title.toLowerCase()}`}>
            <p style={{fontFamily:'helvetica', fontWeight:'200', fontSize:'2.5rem', color:'black'}}>{props.title}</p>
            ...
            <p style={{fontFamily:'helvetica', fontWeight:'200', fontSize:'1.5rem'}}>{props.desc}</p>
        </div>
    )
}
