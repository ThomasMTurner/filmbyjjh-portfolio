...
const PortfolioCard = (props) => {
    ...
    return (
        <div className={`portfolio-card portfolio-card-${props.title.toLowerCase()}`}>
            ...
            <button className='portfolio-card-button' type="button" onClick={() => navigate(`/portfolio/${props.title.toLowerCase().slice(0, 5)}`)}>View more <BsBoxArrowUpRight color={'red'} size={15} /></button>
