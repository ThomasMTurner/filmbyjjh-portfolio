...
const PortfolioCard = (props) => {
    ...
    return (
      ...
      >
        ...
        <div style={{ position:'relative', top:'1rem',width:'70%', borderStyle:'solid', borderColor:'whitesmoke', borderRadius:'0.5rem',  backgroundColor:'whitesmoke', opacity:'0.5', boxShadow:'0px 2px 4px rgba(0, 0, 0, 0.5)', alignSelf:'center'}}>
          <p
            style={{
              textAlign:'center',
              fontFamily: 'helvetica',
