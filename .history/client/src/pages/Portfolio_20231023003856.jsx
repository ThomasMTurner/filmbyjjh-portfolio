...
const PortfolioCard = (props) => {
    ...
    return (
      ...
      >
        ...
        <div style={{ width:'50%', borderStyle:'solid', borderColor:'whitesmoke', borderRadius:'0.5rem', width:'100%', backgroundColor:'whitesmoke', opacity:'0.5', boxShadow:'0px 2px 4px rgba(0, 0, 0, 0.5)'}}>
          <p
            style={{
              fontFamily: 'helvetica',
              fontWeight: '200',
