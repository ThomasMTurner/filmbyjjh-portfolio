...
const ResultsComponent = (props) => {
    ...
    return (
        <div style={{textAlign:'center'}}>
            <p style={{fontFamily:'helvetica', fontWeight:'200', fontSize:'1.5rem', color:'green'}}>Hi there, we found {results} recent updates.</p>
        </div>
    )
}
  ...
  return (
    <div className='editor-updates-container'>
      <div className='editor-create-form-wrapper'>
        ...
        <TagsContainer tagsPerRow={6} setValidationErrors = {setValidationErrors} setPostData = {setPostData} tags={postData.tags}/>
