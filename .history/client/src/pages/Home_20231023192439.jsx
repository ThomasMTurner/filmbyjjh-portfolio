  ...
  return (
    <div className="Home">
        ...
        <div className="quotes-container">
          <p className="quote-header">Meet my clients<span style={{color:'white'}}>.</span></p>
          <QuotesContainer quotes={[<Quote quote="Hello there" reference=" this is my reference text"/> , <Quote quote="Hello there" reference=" this is my reference text"/>]} />
        </div>
    </div>
  );
}
