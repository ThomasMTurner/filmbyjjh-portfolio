...
const PortfolioCard = (props) => {
    ...
    return (
        <div className={`portfolio-card portfolio-card-${props.title.toLowerCase()}`}>
            <p style={{fontFamily:'helvetica', fontWeight:'200', fontSize:'3rem', color:'black'}}>{props.title}</p>
            ...
            <p style={{fontFamily:'helvetica', fontWeight:'200', fontSize:'2rem'}}>{props.desc}</p>
        </div>
    )
}
